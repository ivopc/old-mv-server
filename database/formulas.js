var _ = {
    ...
    Exp = {},
    Utils = {
        exp: require("./experience.json"),
        typechart: require("./typechart.json"),
        dp: require("./droppoints.json"),
        nature: require("./nature.json"),
        statchange: require("./statchange.json")
    };
...
Species.Generate.Shiny = function (num) {
    num = num || 900;
    return Math.floor(Math.random() * num) + 1 == 1;
};

Species.Generate.Gender = function (num) {
    return 1;
};
...
console.log(Exp.Calc.exp2Level(971));
