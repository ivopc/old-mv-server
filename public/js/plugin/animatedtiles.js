(function(){
                    ...
                    Object.keys(tileData).forEach(
                        index => {
                            ...
                            if (tileData[index].hasOwnProperty("animation")) {
                                ...
                                map.layers.forEach(
                                    layer => {
                                        //console.log(layer, layer.tilemapLayer);
    ...
    if (typeof exports !== "undefined") {
        if (typeof module !== "undefined" && module.exports) {
            exports = module.exports = AnimatedTiles;
        }
        exports.AnimatedTiles = AnimatedTiles;
    } else if (typeof define !== "undefined" && define.amd) {
        define("AnimatedTiles", (function() { return root.AnimatedTiles = AnimatedTiles; })() );
    } else {
        root.AnimatedTiles = AnimatedTiles;
    }
