...
Game.Overworld.getExpStatistics = function (exp, level) {
...
Game.Overworld.numberToPedia = function (num) {
...
// pegar itens
Game.Overworld.getItems = function () {
...
Game.Overworld.removeItem = function (id) {
    // descontar item
...
// fazer ação do item
Game.Overworld.setItemAction = function () {
...
Game.Overworld.moveLearnedByNotify = function () {
...
Game.Overworld.dontLearnMoveByNotify = function () {
    this.clearMoveNotification();
};
Game.Overworld.evolveByNotify = function () {
    this.clearEvolveNotification();
    this.successToast.show(this.cache.json.get("language").notify["evolveaction"][this.lang]);
};

// adicionar HP
Game.Overworld.addHp = function (index, hp, hasAnimation, callback) {
...
// adicionar HP
Game.Overworld.addMp = function (index, mp) {
    const monster = this.Data.CurrentMonsters["monster" + index];
...
Game.Overworld.convertMsToDate = function (miliseconds, format) {
...
// tratar data do vip
Game.Overworld.treatVipDate = function (vip_date) {
