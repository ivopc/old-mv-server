...
Game.Overworld.positionToRealWorld = function (position) {
    return position * this.database.overworld.tile.size;
};

// adicionar sprite do jogador
Game.Overworld.addPlayer = function () {
    ...
    //this.player.displayName(this.auth.uid);
...
Game.Overworld.appendCharacter = function (object) {
...
Game.Overworld.appendMapObjects = function (objectsData) {
...
Game.Overworld.appendSpecificObject = function (element) {
...
Game.Overworld.appendWildMonster = function (sprite) {
...
Game.Overworld.preWildBattleEffect = function (cb) {
...
Game.Overworld.appendGrassOverlay = function (x, y) {
...
Game.Overworld.appendGrassParticles = function (x, y) {
...
Game.Overworld.dispatchToasts = function () {
...
Game.Overworld.appendSelfProfile = function (data) {
    ...
    this.selfieClose = new Phaser.Button(this, {
        x: 444,
        y: 12,
    ...
    this.selfieSkinBtn = new Phaser.Button(this, {
        x: 144,
        y: 161,
...
Game.Overworld.toggleSelfSkinBox = function () {
...
Game.Overworld.appendSelfSkinBox = function () {
    ...
    this.selfieSkinPaginationLeft = new Phaser.Button(this, {
        x: 323,
        y: 51,
    ...
    this.selfieSkinPaginationRight = new Phaser.Button(this, {
        x: 353,
        y: 51,
        spritesheet: "market-select-pagination",
        on: {
...
Game.Overworld.appendSelfSkinsInBox = function () {
    this.selfieSkinSlot = [];
    this.selfieSkinView = [];
    ...
    for (let i = 0; i < this.database.interface.selfprofile.skinslots.length; i ++) {
        ...
        this.selfieSkinSlot[i] = new Phaser.Button(this, {
            x: position.x,
            y: position.y,
...
Game.Overworld.appendSelfSkinsCharacterSprites = function () {
...
Game.Overworld.generateSkinsList = function () {
...
Game.Overworld.clearSelfProfile = function () {
...
Game.Overworld.clearSelfProfileSkinBoxCharacters = function () {
    for (let i = 0; i < this.selfieSkinView.length; i ++)
        this.selfieSkinView[i].destroy();
};

Game.Overworld.clearSelfProfileSkinBox = function () {
...
Game.Overworld.appendQuests = function (id) {
    ...
    this.questCloseBtn = new Phaser.Button(this, {
        x: 465,
        y: 4,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.questPaginationLeft = new Phaser.Button(this, {
        x: 34,
        y: 218,
    ...
    this.questPaginationRight = new Phaser.Button(this, {
        x: 63,
        y: 218,
        spritesheet: "quest-pagination-btn",
        on: {
...
Game.Overworld.appendQuestList = function (data) {
...
Game.Overworld.appendSpecificQuest = function (txt) {
...
Game.Overworld.appendAcceptRejectQuest = function (quest_id) {
    ...
    this.acceptBtn = new Phaser.Button(this, {
        x: 109,
        y: 155,
    ...
    this.questCloseBtn2 = new Phaser.Button(this, {
        x: 408,
        y: 43,
        spritesheet: "profile-close-btn",
        on: {
...
Game.Overworld.appendAcceptRejectQuestRewards = function (quest_id) {
...
Game.Overworld.questChangePage = function (page) {
...
Game.Overworld.clearQuestList = function () {
...
Game.Overworld.clearQuestsInterface = function () {
...
Game.Overworld.clearSpecificQuest = function () {
...
Game.Overworld.clearAcceptRejectQuest = function () {
...
Game.Overworld.treatItemIcon = function (id) {
...
Game.Overworld.treatNumberToK = function (num) {
...
Game.Overworld.weather = {};

// chuva
Game.Overworld.weather.rain = function () {
...
Game.Overworld.depthSort = function () {
    ...
    for (let i = 0; i < order.length; i ++)
        this.containers.main.bringToTop(_.findWhere(sprites, {order: order[i]}).gameobject);
};

// delay para evitar bugs de posição do player online
Game.Overworld.mapEntranceDelay = function () {
...
Game.Overworld.toggleParty = function () {

    this.player._data.stop = true;
    this.appendPartyInterface();
};
// mostrar/ocultar chat
Game.Overworld.toggleChat = function () {
...
// mostrar quests
Game.Overworld.toggleQuests = function () {
    this.player._data.stop = true;
    this.appendQuests();
};

// mostrar/ocultar notificações
Game.Overworld.toggleNotifications = function () {
...
Game.Overworld.appendWildMenu = function (data) {

    const lang = this.cache.json.get("language");

    this.wildTooltipOppened = false;
    this.wildTooltipType = data.canSeeSP ? 1 : 0;

    this.wildBox = this.add.sprite(0, this.game.config.height - 47, "wild-box")
        .setOrigin(0, 0)
        .setScrollFactor(0);

    this.containers.interface.add(this.wildBox);

    this.btn.battle = new Phaser.Button(this, {
        x: 272,
        y: 200,
        ...
        on: {
            click: () => {
                this.addLoader();
                this.acceptRejectWildBattle(1);
                this.btn.battle.sprite.input.enabled = false;
                this.btn.run.sprite.input.enabled = false;
            }
        },
        frames: {click: 1, over: 2, up: 0, out: 0}
    });

    this.btn.battle.sprite.setScrollFactor(0);
    this.containers.interface.add(this.btn.battle.sprite);

    this.btn.run = new Phaser.Button(this, {
        x: 375,
        y: 200,
        spritesheet: "run-button",
        on: {
            click: () => {
                // enviar ao servidor que tentou fugit
                this.acceptRejectWildBattle(0);
    ...
    this.btn.run.sprite.setScrollFactor(0);
    this.containers.interface.add(this.btn.run.sprite);

    this.btn.info = new Phaser.Button(this, {
        x: 233,
        y: 199,
        spritesheet: "info-button",
        on: {
            click: () => {
                this.appendWildTooltip(data);
            }
        },
        frames: {click: 1, over: 2, up: 0, out: 0}
    });

    this.btn.info.sprite.setScrollFactor(0);
    this.containers.interface.add(this.btn.info.sprite);

    this.text.battle = this.add.text(0, 0, lang.prebattle["acceptbattle"][this.lang], { 
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
        .setScrollFactor(0)
        .setOrigin(0.5)
        .setX(this.btn.battle.sprite.getCenter().x)
        .setY(this.btn.battle.sprite.getCenter().y);

    this.containers.interface.add(this.text.battle);
    
    this.text.run = this.add.text(0, 0, lang.prebattle["run"][this.lang], { 
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
        .setScrollFactor(0)
        .setOrigin(0.5)
        .setX(this.btn.run.sprite.getCenter().x)
        .setY(this.btn.run.sprite.getCenter().y);

    this.containers.interface.add(this.text.run);

    this.text.name = this.add.text(93, 205, this.database.monsters[data.id].name, {
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
    ...
    this.containers.interface.add(this.text.name);

    this.rating = this.add.sprite(73, 211, "rating")
        .setOrigin(0, 0)
        .setScrollFactor(0)
        .setFrame(this.database.monsters[data.id].rating);

    this.containers.interface.add(this.rating);

    this.text.name.setOrigin(0.5);
    this.text.name.setX(this.rating.getCenter().x);
};

Game.Overworld.appendWildTooltip = function (data) {
...
Game.Overworld.clearWildTooltip = function () {
...
Game.Overworld.appendPartyInterface = function () {
    const party = new Interfaces.Party(this, {type: "party"});
    party.append();
};

Game.Overworld.appendBag = function () {
    const bag = new Interfaces.Bag(this);
    bag.append();
};

// (método principal) excluir interfaces de maneira genérica
Game.Overworld.clearInterface = function () {
...
Game.Overworld.clearWildBoxInterface = function () {
    this.wildBox.destroy();
    this.rating.destroy();
};


Game.Overworld.showHideDPad = function (bool) {
    if (this.isMobile)
...
Game.Overworld.enableDisableButtonsInterface = function (bool) {
    _.each(this.icon, button => {
        button.sprite.input.enabled = bool;
    });
};

Game.Overworld.appendMonsterBox = function (data) {
    ...
    this.boxClose = new Phaser.Button(this, {
        x: 447,
        y: 11,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.boxPaginationLeft = new Phaser.Button(this, {
        x: 279,
        y: 57,
    ...
    this.boxPaginationRight = new Phaser.Button(this, {
        x: 295,
        y: 57,
        spritesheet: "box-pagination",
        on: {
    ...
    for (let i = 0; i < this.database.interface.box.partyslots.length; i ++) {
        inPartyBtn[i] = new Phaser.Button(this, {
    ...
    for (let i = 0; i < this.database.interface.box.boxslots.length; i ++) {
        inBoxBtn[i] = new Phaser.Button(this, {
...
Game.Overworld.inPartyOnDragEnd = function (monster, index) {
        ...
        if (slotPosition.x >= this.boxSprites.inBoxBtn[i].sprite.x && slotPosition.x <= this.boxSprites.inBoxBtn[i].sprite.x + width && 
           slotPosition.y >= this.boxSprites.inBoxBtn[i].sprite.y && slotPosition.y <= this.boxSprites.inBoxBtn[i].sprite.y + height) {
            ...
            if (this.boxSprites.inBoxBtn[i].isEmpty) {
                ...
                console.log(this.Data.CurrentMonsters["monster" + index]);
                ...
                // criando novo objeto dos monstros do jogador
                let new_order = {
                    party: _.clone(this.Data.CurrentMonsters),
                    box: _.clone(this.Data.BoxMonsters)
                };
...
Game.Overworld.inBoxOnDragEnd = function (monster, index) {
        ...
        if (slotPosition.x >= this.boxSprites.inPartyBtn[i].sprite.x && slotPosition.x <= this.boxSprites.inPartyBtn[i].sprite.x + width && 
           slotPosition.y >= this.boxSprites.inPartyBtn[i].sprite.y && slotPosition.y <= this.boxSprites.inPartyBtn[i].sprite.y + height) {
            ...
            if (this.boxSprites.inPartyBtn[i].isEmpty) {
                ...
                this.Data.CurrentMonsters["monster" + i] = _.clone(this.Data.BoxMonsters[data.index]);
...
Game.Overworld.reorganizeParty = function () {
    const 
        monstersArray = []
        newMonsterObject = {};
...
Game.Overworld.appendInPartyMonsters = function () {
...
Game.Overworld.appendInBoxMonsters = function () {
    //const mons = _.chunk(this.Data.BoxMonsters, 32);
    ...
    for (let i = 0; i < 32; i ++) {
        ...
        //let index = monster.slot_position;
...
Game.Overworld.appendInBoxMonsterInfo = function (i) {
...
Game.Overworld.clearInPartyMonstersBox = function () {
...
Game.Overworld.clearInBoxMonsters = function () {
...
Game.Overworld.clearInBoxSlotsStates =  function () {
    for (let i = 0; i < this.boxSprites.inBoxBtn.length; i ++) {
...
Game.Overworld.clearInBoxSelectedMonsterInfo = function () {
...
Game.Overworld.clearBox = function () {
...
Game.Overworld.appendPlayerProfileInterface = function (uid, nickname) {
    ...
    this.profileButtons.close = new Phaser.Button(this, {
        x: 446,
        y: 12,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.profileButtons.add = new Phaser.Button(this, {
        x: 132,
        y: 197,
    ...
    this.profileButtons.inviteBattle = new Phaser.Button(this, {
        x: 241,
        y: 197,
        spritesheet: "items-button",
        on: {
    ...
    this.profileButtons.block = new Phaser.Button(this, {
        x: 351,
        y: 197,
        spritesheet: "items-button",
        on: {
...
Game.Overworld.appendDynamicPlayerProfileInterface = function (data) {
...
Game.Overworld.clearPlayerProfileInterface = function () {
...
Game.Overworld.appendMarket = function () {
    ...
    for (let i = 0; i < 5; i ++) {
        ...
        //tab-party-button
        //80x30
        this.mktTabBtn[i] = new Phaser.Button(this, {
            x: tab.x,
            y: tab.y,
            spritesheet: "tab-party-button",
            on: {
    ...
    // adiciona paginação (<<)
    this.mktPaginationPrevious = new Phaser.Button(this, {
        x: 429,
        y: 48,
        spritesheet: "market-select-pagination",
        on: {
    ...
    // adiciona paginação (>>)
    this.mktPaginationNext = new Phaser.Button(this, {
        x: 445,
        y: 48,
        spritesheet: "market-select-pagination",
        on: {
    ...
    this.mktClose = new Phaser.Button(this, {
        x: 450,
        y: 8,
        spritesheet: "profile-close-btn",
        on: {
    ...
    for (let i = 0; i < this.database.interface.market.slots.length; i ++) {
        ...
        this.mktSlots[i] = new Phaser.Button(this, {
                x: slot.x,
                y: slot.y,
...
Game.Overworld.appendMarketSlotElements = function () {
...
Game.Overworld.changeMarketPage = function () {
...
Game.Overworld.marketIncAmount = function () {
...
Game.Overworld.marketDecAmount = function () {
...
Game.Overworld.appendMarketConfirmWindow = function (index) {
    ...
    this.mktSelectAdd = new Phaser.Button(this, {
            x: 263,
            y: 75,
    ...
    this.mktSelectDec = new Phaser.Button(this, {
            x: 263,
            y: 91,
            spritesheet: "market-select-amount",
            on: {
    ...
    this.mktBtnConfirm = new Phaser.Button(this, {
            x: 136,
            y: 113,
    ...
    this.mktBtnReject = new Phaser.Button(this, {
            x: 249,
            y: 113,
...
Game.Overworld.clearMarketInterface = function () {
    if (this.mktWindowOpenned)
        this.clearMarketConfirmWindow();
...
Game.Overworld.clearMarketSlotElements = function () {
...
Game.Overworld.clearMarketConfirmWindow = function () {
...
Game.Overworld.appendPvPInviteBox = function (id, nickname) {
    ...
    this.btn.accept = new Phaser.Button(this, {
        x: this.inviteBox.x,
    ...
    this.btn.reject = new Phaser.Button(this, {
...
Game.Overworld.appendChatMessages = function () {
...
Game.Overworld.receiveChatMessage = function (data) {
...
Game.Overworld.appendChatNotification = function () {
...
Game.Overworld.clearChatNotification = function () {
...
Game.Overworld.useParchment = function (data) {
...
Game.Overworld.addNotification = function (data) {
...
Game.Overworld.appendNotifications = function (data) {
    ...
    this.notifyPaginationLeft = new Phaser.Button(this, {
    ...
    this.notifyPaginationRight = new Phaser.Button(this, {
...
Game.Overworld.appendNotifyElements = function () {
    this.notifyDivs = [];
    this.notifyDivText = [];
    this.notifyButton = [];
...
Game.Overworld.clearNotifications = function () {
...
Game.Overworld.clearNotificationElements = function () {
    for (let i = 0; i < this.notify.data.length; i ++) {
...
Game.Overworld.appendNotificationBadge = function () {
...
Game.Overworld.increaseNotifyBadge = function () {
...
Game.Overworld.decreaseNotifyBadge = function () {
    this.notify.count --;
...
Game.Overworld.appendMoveNotification = function (data) {
    ...
    this.moveNotifyClose = new Phaser.Button(this, {
        x: 461,
        y: 6,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.buttonLearn = new Phaser.Button(this, {
        x: 93,
        y: 191,
    ...
    this.buttonDontLearn = new Phaser.Button(this, {
        x: 249,
        y: 191,
        spritesheet: "learn-btn",
        on: {
...
Game.Overworld.clearMoveNotification = function () {
...
Game.Overworld.appendEvolveNotification = function (data) {
    ...
    this.evolveNotifyClose = new Phaser.Button(this, {
        x: 461,
        y: 6,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.buttonEvolve = new Phaser.Button(this, {
        x: 171,
        y: 194,
        spritesheet: "learn-btn",
        on: {
...
Game.Overworld.clearEvolveNotification = function () {
...
Game.Overworld.appendMarketPlaceNotification = function (data) {
    // remove loader
    this.removeLoader();
    console.log(data, "HELLOUUU HEXA");
    // -> resposta: 90
    ...
    this.marketplaceNotifyClose = new Phaser.Button(this, {
        x: 461,
        y: 6,
        spritesheet: "profile-close-btn",
        on: {
...
Game.Overworld.appendLearnMove = function (data, callback) {
    ...
    this.learnMoveClose = new Phaser.Button(this, {
        x: 461,
        y: 6,
        spritesheet: "profile-close-btn",
        on: {
    ...
    this.learnMoveInfoBtn = new Phaser.Button(this, {
        x: 10,
        y: 191,
        spritesheet: "info-button",
        on: {
    ...
    for (let i = 0; i < 4; i ++) {
        ...
        this.learnMovesBtn[i] = new Phaser.Button(this, {
...
Game.Overworld.clearLearnMove = function () {
...
Game.Overworld.appendMoveWindowInfo = function (move) {
    ...
    this.moveWindowClose = new Phaser.Button(this, {
        x: 380,
        y: 63,
        spritesheet: "profile-close-btn",
        on: {
...
Game.Overworld.clearMoveWindow = function () {
...
Game.Overworld.loadMonsterSprite = function (id, callback) {
...
Game.Overworld.addMonsterAnimations = function (id, sprite) {
...
Game.Overworld.testColl = function (position) {
...
Game.Overworld.appendInitialMonsterMenu = function (variable, callback) {
    ...
    btn[0] = new Phaser.Button(this, {
        x: 2,
        y: 35,
        spritesheet: "initial-select-btn",
        on: {
            click: () => {
                this.appendConfirmInitialMonster(10, variable, callback);
            }
        },
        frames: {click: 2, over: 1, up: 0, out: 0}
    });
    ...
    name[0] = this.add.text(0, 0, this.database.monsters[10].name, { 
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
    ...
    btn[1] = new Phaser.Button(this, {
        x: 164,
        y: 35,
        spritesheet: "initial-select-btn",
        on: {
            click: () => {
                this.appendConfirmInitialMonster(12, variable, callback);
            }
        },
        frames: {click: 2, over: 1, up: 0, out: 0}
    });
    ...
    name[1] = this.add.text(0, 0, this.database.monsters[12].name, { 
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
    ...
    btn[2] = new Phaser.Button(this, {
        x: 326,
        y: 35,
        spritesheet: "initial-select-btn",
        on: {
            click: () => {
                this.appendConfirmInitialMonster(15, variable, callback);
            }
        },
        frames: {click: 2, over: 1, up: 0, out: 0}
    });
    ...
    name[2] = this.add.text(0, 0, this.database.monsters[15].name, {
        fontFamily: "Century Gothic", 
        fontSize: 14, 
        color: "#fff" 
    })
    ...
    this.addMonsterAnimations(10, mons[0]);
    ...
    this.addMonsterAnimations(12, mons[1]);
    ...
    this.addMonsterAnimations(15, mons[2]);
};

Game.Overworld.appendConfirmInitialMonster = function (id, variable, callback) {
