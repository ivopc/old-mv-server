Interfaces.MonsterStatus = function (scene) {
    this.scene = scene;
};

// (método principal) Abrir status do monstro especifico
Interfaces.MonsterStatus.prototype.append = function (index) {
...
// Limpar Interface
Interfaces.MonsterStatus.prototype.clear = function () {
...
Interfaces.MonsterStatus.prototype.appendSpecificMonsterMenuBase = function (index) {
...
Interfaces.MonsterStatus.prototype.appendMonsterSpriteMenu = function (id) {
    ...
    this.scene.addMonsterAnimations(id, this.monsterMenu.sprite);
    
    // this.monsterMenu.sprite.setOrigin(
    //     this.database.battle.sprites[id].action.player.origin.x, 
    //     this.database.battle.sprites[id].action.player.origin.y
    // );
};

// Appendar botões dos menus
Interfaces.MonsterStatus.prototype.appendSpecificMonsterButtonsMenu = function (index) {

    this.scene.btn.partyBack = new Phaser.Button(this.scene, {
        x: 436,
        y: 195,
        ...
        on: {
            click: () => {
                ...
                if (this.scene.scene.key == "battle" && this.scene.interfacesHandler.party.type != "defeated") {
                    ...
                    this.scene.interfacesHandler.party = new Interfaces.Party(this.scene, {type: "defeated"});
    ...
    this.scene.btn.info = new Phaser.Button(this.scene, {
    ...
    this.scene.btn.statistics = new Phaser.Button(this.scene, {
    ...
    this.scene.btn.moves = new Phaser.Button(this.scene, {
...
// {Menu} - Informações
Interfaces.MonsterStatus.prototype.appendSpecificMonsterInfoMenu = function (index) {

    this.scene.partyCurrentOpenedTab = 1;
...
// {Menu} - Estatísiticas
Interfaces.MonsterStatus.prototype.appendSpecificMonsterStatisticsMenu = function (index) {

    this.scene.partyCurrentOpenedTab = 2;
...
// {Menu} - Moves
Interfaces.MonsterStatus.prototype.appendSpecificMonsterMovesMenu = function (index) {

    this.scene.partyCurrentOpenedTab = 3;
...
Interfaces.MonsterStatus.prototype.appendMoveWindowInfo = function (move) {
    ...
    this.scene.moveWindowClose = new Phaser.Button(this.scene, {
        x: 380,
        y: 63,
...
Interfaces.MonsterStatus.prototype.clearMoveWindow = function () {
...
Interfaces.MonsterStatus.prototype.switchSpecificMonsterTab = function (tab, newtab, index) {
    this.scene.clearInterface();
...
Interfaces.MonsterStatus.prototype.clearSpecificPartyTabInterface = function (currentOpenedTab) {
