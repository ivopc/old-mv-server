Interfaces.Bag = function (scene) {
    this.scene = scene;
};

// Add interface de bag
Interfaces.Bag.prototype.append = function () {
    ...
    this.scene.itemsClose = new Phaser.Button(this.scene, {
        x: 462,
        y: 3,
...
// Limpar interface
Interfaces.Bag.prototype.clear = function () {
...
Interfaces.Bag.prototype.appendItemWindow = function (cellContainer, cellIndex) {
    ...
    const closeBtn = new Phaser.Button(this.scene, {
        x: 294,
        y: 47,
    ...
    switch (this.scene.scene.key) {
        case "overworld": {
            ...
            if (hasTwoBtns) {
                use = new Phaser.Button(this.scene, {
                    ...
                    on: {
                        click: () => {
                            ...
                            this.scene.interfacesHandler.party = new Interfaces.Party(this.scene, {type: "item"});
                ...
                equip = new Phaser.Button(this.scene, {
                ...
                on: {
                    click: () => {
                        ...
                        switch (this.scene.database.items[this.scene.selectedItem].type) {
                            ...
                            case "mana_potion":
                            {
                                this.scene.interfacesHandler.party = new Interfaces.Party(this.scene, {type: "battleItem"});
