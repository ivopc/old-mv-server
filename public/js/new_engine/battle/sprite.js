...
Game.Battle.startWildPresentation = function (callback) {
    // inserir chão (piso)
...
Game.Battle.startPlayerPresentation = function (callback) {
...
Game.Battle.startTamerPresentation = function (callback) {
    // adiciona "chão" (piso) do jogador
...
Game.Battle.startOtherPlayerPresentation = function (callback) {
    // adiciona "chão" (piso) do jogador
    const otherPlayerFloor = this.add.sprite(
        480 + 107,
        120,
...
Game.Battle.startFieldPresentation = function (callback) {
...
Game.Battle.insertRawPlayerAndWildMonsters = function () {
...
Game.Battle.insertRawPlayerVsTamer = function () {
    var floor = [];
    floor[0] = this.add.sprite(
        58,
        120,
...
Game.Battle.insertRawPlayerVersusPlayer = function () {
...
Game.Battle.endPvP = function (callback, winner_uid) {
    /*
...
Game.Battle.insertActionMenu = function () {
    ...
    // movimentos (batalha) 
    this.butt[0] = new Phaser.Button(this, {
        x: 268,
        y: 166,
    ...
    // mochila
    this.butt[1] = new Phaser.Button(this, {
        x: 371,
        y: 166,
        spritesheet: "button_new",
        on: {
    ...
    // bracelete (monstros)
    this.butt[2] = new Phaser.Button(this, {
        x: 268,
        y: 200,
        spritesheet: "button_new",
        on: {
    ...
    // fugir 
    this.butt[3] = new Phaser.Button(this, {
        x: 371,
        y: 200,
        spritesheet: "button_new",
        on: {
...
Game.Battle.insertFightMenu = function () {
    this.clearMenu();
    ...
    this.butt[4] = new Phaser.Button(this, {
        x: 343,
        y: 185,
...
Game.Battle.insertPartyMenu = function () {

    this.clearMenu();

    this.interfacesHandler.party = new Interfaces.Party(this, {type: "battleParty"});
    this.interfacesHandler.party.append();
};

// Inserir menu dos itens
Game.Battle.insertItemsMenu = function () {
    this.interfacesHandler.bag = new Interfaces.Bag(this);
    this.interfacesHandler.bag.append();
};

// (método principal) excluir interfaces de maneira genérica
Game.Battle.clearInterface = function () {
...
Game.Battle.clearMenu = function () {
...
Game.Battle.disableEnableButtons = function (bool) {
    for (let i = 0, l = this.butt.length; i < l; i++)
        this.butt[i].sprite.input.enabled = bool;
};

// adicionar animações do monstro ao gameobject
Game.Battle.addMonsterAnims = function (monster_id, gameobject) {
...
Game.Battle.moves.player[1] = function (callback) {
...
Game.Battle.moves.player[2] = function (callback) {
...
Game.Battle.moves.player[3] = function (callback) {
    callback();
};

Game.Battle.moves.player[4] = function (callback) {
    callback();
};

Game.Battle.moves.player[5] = function (callback) {
    callback();
};

Game.Battle.moves.opponent[1] = function (callback) {
...
Game.Battle.moves.opponent[2] = function (callback) {
    //callback();
...
Game.Battle.moves.opponent[3] = function (callback) {
    callback();
};

Game.Battle.moves.opponent[4] = function (callback) {
    callback();
};

Game.Battle.moves.opponent[5] = function (callback) {
    callback();
};
...
// chuva
Game.Battle.weather.rain = function () {
...
Game.Battle.convertNumberToBuffNerfText = num => num > 0 ? "+" + num : String(num);

Game.Battle.buffnerf = function () {
...
Game.Battle.checkAndAppendBuffNerf = function (clear) {
...
Game.Battle.appendUpdateBuffNerf = function (target, stat, value) {
...
// remover buff/nerf
Game.Battle.removeBuffNerf = function (target, stat) {
    if (stat == "all") {
...
Game.Battle.addMonsterAnimations = function (id, sprite) {
...
Game.Battle.waitChose = function () {
    this.clearMenu();
...
Game.Battle.appendHourglass = function () {
...
Game.Battle.appendTimer = function () {
...
Game.Battle.removeTimerHouglass = function () {
...
Game.Battle.formatTime = function (seconds) {
...
Game.Battle.appendChatMessages = function () {
...
Game.Battle.toggleChat = function () {
...
Game.Battle.receiveChatMessage = function (data) {
...
Game.Battle.loadMonsterSprite = function (id, callback) {
...
Game.Battle.getFirstPlayerMonsterAlive = function (monsters) {
...
Game.Battle.getFirstPlayerMonsterAliveIndex = function (monsters) {
    for (let i = 0; i < 6; i++)
        if (monsters["monster" + i] && monsters["monster" + i].current_HP > 0)
            return i;
...
Game.Battle.getMonsterDataById = function (id, monsters) {
    for (let i = 0; i < 6; i ++)
...
// Pegar index do monstro na party pelo ID do monstro especificado 
Game.Battle.getIndexById = function (id, monsters) {
    for (let i = 0; i < 6; i ++)
        if (monsters["monster" + i] && monsters["monster" + i].id == id)
            return i;
