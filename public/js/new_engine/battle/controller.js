...
Game.Battle.doActions = function (actions) {
    ...
    all_fn = pre_fn.concat(regular_fn).concat(post_fn);
...
// Fazer ação pre turn
Game.Battle.doPre = function (action, index, next) {
...
// Fazer ação regular
Game.Battle.doRegular = function (action, index, next) {
...
Game.Battle.doPost = function (action, index, next) {
...
Game.Battle.moveDamage = function (action, callback) {
    ...
    if (!action.param.canDoMove) {
        async.series([
            next => {
                ...
                console.log(phrase + foe, "OLA KKKKKKKKKKKKKKKKKK");
...
Game.Battle.moveBuffNerf = function (action, callback) {
    this.currentMove.id = action.param.move_id;
    this.currentMove.attacker = action.id;
...
Game.Battle.moveStatusProblem = function (action, callback) {
    this.currentMove.id = action.param.move_id;
    this.currentMove.attacker = action.id;
...
Game.Battle.useHealthPotion = function (action, callback) {
...
Game.Battle.useSeal = function (action, callback) {
...
Game.Battle.changeMonster = function (action, callback) {
...
Game.Battle.changePvPMonster = function (action, callback) {
    // criando novo objeto dos monstros do jogador
...
// Executar `awake`
Game.Battle.awaked = function (action, callback) {
    let target,
        monsname,
        foe = "";
...
Game.Battle.dropItem = function (action, index, callback) {
...
Game.Battle.monsterFainted = function (action, index, callback) {
        ...
        async.series([
            ...
            next => {
                ...
                if (action.param.battleEnded) {
                    ...
                    this.clearMenu();
                    this.interfacesHandler.party = new Interfaces.Party(this, {type: "defeated"});
...
// Executar param `run`
Game.Battle.tryRun = function (action, callback) {
    // se pode fugir
    if (action.param) {
...
Game.Battle.giveExpRaw = function (expData, callback) {
...
// Verificando se errou o hit
Game.Battle.checkHited = function () {};

// Verificando se pode fazer o move
Game.Battle.checkCanDoMove = function () {};

// Trocar monstro derrotado
Game.Battle.changeFaintedMonster = function () {
    // limpa interface
    this.interfacesHandler.party.clear(true);
...
Game.Battle.changeFaintedMonsterPvP = function (action, callback) {
...
Game.Battle.bothFaintedPvP = function (action, callback) {
    async.series([
        // texto de faintou
        next => {
            this.clearMenu();
...
Game.Battle.poisonDiscount = function (action, target, callback) {
...
// Descontar HP
Game.Battle.discountHealthPoints = function (action, next, target, dontNeedToCheckPvPTarget) {
...
// Descontar MP
Game.Battle.discountMana = function (action, next) {
...
// Finalizar turno
Game.Battle.finishTurn = function () {
...
// Finalizar batalha
Game.Battle.finishBattle = function (playerWins, dontNeedToInjectAction) {
...
Game.Battle.treatActionError = function (data) {
...
Game.Battle.getExpPercetage = function (monster) {
    const 
...
Game.Battle.getExpStatistics = function (exp, level) {
...
Game.Battle.numberToPedia = function (num) {
...
Game.Battle.setExpLevelValue = function (earned, index) {
...
Game.Battle.removeItem = function (id) {
    // descontar item
