Game.Battle.initConnection = function () {
...
Game.Battle.triggerConnectionEvents = function () {
...
Game.Battle.triggerPvPEvents = function (channel) {
...
Game.Battle.triggerComplementarEvents = function () {
...
Game.Battle.unsetPvPEvents = function () {
...
Game.Battle.sendMove = function (id) {
...
// usar item
Game.Battle.useItem = function (data) {
    this.Socket.emit("30", {
        action: "item",
        param: data
    });
...
Game.Battle.sendSwitchMonster = function (id) {
...
Game.Battle.sendSwitchDefeatedMonsterPvP = function (id) {
    this.Socket.emit("31", {id});
};

// correr da batalha
Game.Battle.sendRun = function () {
...
Game.Battle.sendChatMessage = function (message) {
...
Game.Battle.receiveMoveResponse = function (data) {
    this.doActions(data.actions);
};

// receber resposta do server
Game.Battle.receivePvPResponse = function (data) {
...
Game.Battle.claimTimer = function () {
    this.Socket.emit("39");
};