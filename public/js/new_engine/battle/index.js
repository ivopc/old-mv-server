...
Game.Battle.Extends = Phaser.Scene;

Game.Battle.initialize = function () {
    Phaser.Scene.call(this, {key: "battle"});
};

Game.Battle.init = function (data) {
...
Game.Battle.create = function () {
    ...
    switch (+this.battleParams.battleInfo.battle_type) {
        ...
        case 3: {
            ...
            this.chatIcon = new Phaser.Button(this, {
                x: 447,
                y: 10,
                spritesheet: "icons",
                on: {
...
//Game.Battle.update = function () {};

// pegar dados do jogador
Game.Battle.getPlayerData = function (callback) {
...
Game.Battle.getPlayerDataCallback = function () {};

Game.Battle.stopScene = function () {
...
Game.Battle.monsterMenu = {
    player: {},
    opponent: {}
};


Game.Battle.currentMove = {
    id: null,
    attacker: null,
    enabled: false,
    callback: null
